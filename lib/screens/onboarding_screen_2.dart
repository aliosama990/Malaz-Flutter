...
import 'package:malaz_app/screens/onboarding_screen_3.dart';
...
class _OnboardingScreen2State extends State<OnboardingScreen2>
  ...
  Widget build(BuildContext context) {
    ...
    final imageHeight = scaled(isCompact ? 278.0 : 310.0);
    final titleFontSize = scaled(isCompact ? 26.5 : 29.0);
                ...
                Expanded(
                  child: Column(
                    children: [
                      ...
                      FadeTransition(
                        ...
                        child: SlideTransition(
                          ...
                          child: Transform.translate(
                            offset: Offset(0, scaled(isCompact ? 2 : -6)),
                            child: SizedBox(
                      ...
                      SizedBox(height: scaled(isCompact ? 46 : 58)),
                      FadeTransition(
                        opacity: _fadeAnimation,
                        child: SlideTransition(
                          position: _slideAnimation,
                          child: Center(
                            child: ConstrainedBox(
                              constraints:
                                  BoxConstraints(maxWidth: scaled(340)),
                              child: Text(
